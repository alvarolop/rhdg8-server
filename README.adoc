...
==== Monitoring RHDG 8 with Grafana
...
oc adm policy add-scc-to-user allow-grafana-userid-472 -z rhdg-grafana -n alvaro-test
----
...
helm repo update
helm install rhdg-grafana grafana/grafana -f values.yaml --set namespaceOverride=alvaro-test
----
...
*Basic error:*
    Error creating: pods "rhdg-grafana-55fc5c69b6-" is forbidden: unable to validate against any security context constraint: [provider restricted: .spec.securityContext.fsGroup: Invalid value: []int64{472}: 472 is not an allowed group spec.initContainers[0].securityContext.runAsUser: Invalid value: 0: must be in the ranges: [1000610000, 1000619999] spec.containers[0].securityContext.runAsUser: Invalid value: 472: must be in the ranges: [1000610000, 1000619999]]

    Error creating: pods "rhdg-grafana-d8d55bc96-" is forbidden: unable to validate against any security context constraint: [provider restricted: .spec.securityContext.fsGroup: Invalid value: []int64{472}: 472 is not an allowed group spec.containers[0].securityContext.runAsUser: Invalid value: 472: must be in the ranges: [1000610000, 1000619999]]

    Error creating: pods "rhdg-grafana-5b4cb949c4-" is forbidden: unable to validate against any security context constraint: [
        provider restricted:
         .spec.securityContext.fsGroup: Invalid value: []int64{472}: 472 is not an allowed group 
         spec.initContainers[0].securityContext.runAsUser: Invalid value: 0: must be in the ranges: [1000610000, 1000619999] 
         spec.containers[0].securityContext.runAsUser: Invalid value: 472: must be in the ranges: [1000610000, 1000619999]]
*Template* 
    securityContext:
        runAsUser: 472
        runAsGroup: 472
    ...
    Error creating: pods "rhdg-grafana-55fc5c69b6-" is forbidden: unable to validate against any security context constraint: [provider restricted: .spec.securityContext.fsGroup: Invalid value: []int64{472}: 472 is not an allowed group spec.initContainers[0].securityContext.runAsUser: Invalid value: 0: must be in the ranges: [1000610000, 1000619999] spec.containers[0].securityContext.runAsUser: Invalid value: 472: must be in the ranges: [1000610000, 1000619999] spec.initContainers[0].securityContext.runAsUser: Invalid value: 0: must be in the ranges: [1000610000, 1000619999] spec.containers[0].securityContext.runAsUser: Invalid value: 472: must be in the ranges: [1000610000, 1000619999]]
