...
To customize the Helm Chart, you will need to fork the official upstream chart adn modify the configuration needed. In my case, I have forked it https://github.com/alvarolop/infinispan-helm-charts?organization=alvarolop&organization=alvarolop[here], in order to change several aspects of the configuration.
