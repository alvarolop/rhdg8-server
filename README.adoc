...
[source, bash]
----
cp -r redhat-datagrid-8.1.0-server/server redhat-datagrid-8.1.0-server/server-01
cp -r redhat-datagrid-8.1.0-server/server redhat-datagrid-8.1.0-server/server-02
----
...
[source, bash]
----
oc process -f templates/rhdg-01-operator-xsite.yaml \
...
[source, bash]
----
oc process -f templates/rhdg-02-cluster-xsite.yaml \
